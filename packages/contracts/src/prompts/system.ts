...
export function composeSystemPrompt({
  ...
  // questions surface: an inline form in the originating assistant message,
  // with answers returned as the next user message. Mirrors the
